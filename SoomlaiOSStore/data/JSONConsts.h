...
/**
 * This class contains all static const String names of the keys/vals in the JSON being parsed all around the sdk.
 */

extern NSString *const JSON_STORE_CURRENCIES;
...
extern NSString *const JSON_MARKETITEM_MARKET_PRICE;
extern NSString *const JSON_MARKETITEM_MARKET_TITLE;
extern NSString *const JSON_MARKETITEM_MARKET_DESC;
extern NSString *const JSON_MARKETITEM_MARKET_PRICE_WITH_CURRENCY_SYMBOL;
...
extern NSString *const JSON_PURCHASE_TYPE_MARKET;
extern NSString *const JSON_PURCHASE_TYPE_VI;

extern NSString *const JSON_PURCHASE_MARKET_ITEM;
